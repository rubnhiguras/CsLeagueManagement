...
function HomePage() {
    ...
    const logo_white = '/src/assets/CSLeague_icon.svg'
    ...
    <div id="headersection" className="hero-section">
        <div id="hero-text" className="hero-text">
            ...
            <h1>
                La App oficial de la <strong>CSLeague</strong>.
            </h1> 
            <div id="call-to-action" className="call-to-action">
                <div className="cta-text">
                    <h2>Tu liga, siempre al alcance</h2>
    ...
    <div id="features-section" className="features-section">
        <div className="feature">
            ...
            <h3>Gestión Integral de Equipos</h3>
            <p>
                Registra equipos, jugadores y delegados. Administra inscripciones, alineaciones y sanciones desde un solo lugar.
            </p>
        </div>
        <div className="feature">
            <i className="fas fa-calendar-check"></i>
            <h3>Calendario y Partidos Oficiales</h3>
            <p>
        ...
        <div className="feature">
            ...
            <h3>Clasificación y Estadísticas</h3>
            <p>
        ...
        <div className="feature">
            ...
            <h3>Disponible en Web y App</h3>
            <p>
                CSLeague está disponible desde cualquier dispositivo. Sigue tu equipo, consulta resultados o administra la liga desde tu móvil o PC.
            </p>
        </div>
    </div>
    ...
    <div id="contactsection" className="hero-section">
        <div className="hero-text">
            ...
            <p>¿Tienes dudas o necesitas asistencia?</p>
            <p>Estamos aquí para ayudarte en todo lo relacionado con la CSLeague.</p>
            <p>Teléfono: +34 600 123 456</p>
            <p>Correo electrónico: soporte@csleague.es</p>
        </div>
    </div>
</div>
